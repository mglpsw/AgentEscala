...
echo "1. Criar um novo Proxy Host para ${PUBLIC_DOMAIN}."
echo "2. Forward Hostname/IP: IP do CT 102 ou loopback visível ao NPM."
echo "3. Forward Port: ${BACKEND_HOST_PORT}."
echo "4. Scheme: http."
echo "5. Custom SSL/local certificate. Não habilitar Force SSL."
echo "6. Testar /health e /metrics após salvar."
echo ""
